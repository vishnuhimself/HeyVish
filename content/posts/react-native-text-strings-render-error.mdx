...
### 1. Direct Text in View Component
...
2. **Component Structure**: I structure my components like this:
...
3. **Style Organization**: Keep text-related styles (fontSize, fontWeight, color, etc.) on Text components, not View components.
